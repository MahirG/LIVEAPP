  ...
  return (
    <div className="mx-auto grid min-h-[calc(100vh-64px)] max-w-5xl items-center gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1fr_420px] lg:px-8">
      <div>
        ...
        <div className="mt-7 flex items-center gap-2 text-xs font-semibold text-[#6f7682]"><LockKeyhole className="size-4 text-[#4ac39d]" /> Sessions are refreshed through request-scoped SSR cookies.</div>
      </div>
      <AuthPanel />
    </div>
  );
